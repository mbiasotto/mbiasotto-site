...
$pageTitle = 'Desenvolvimento de Sites Sorocaba | Sites Responsivos Freelancer';
...
$heroTitle = 'Desenvolvimento de Sites';
                ...
                <div class="col-lg-10">
                    <div class="service-page-content bg-white p-5 rounded shadow-sm">
                        ...
                        <div class="text-center mb-5">
                            <h1 class="service-page-title">Desenvolvimento de Sites</h1>
